...
final class ListComponent extends TableComponent
{
    ...
    */
    ...
    public function route(){
        Route::get('/beneficios', static::class)->name('admin.beneficios');
    }
    ...
    */
    protected function actions(){
        ...
        return [
            Link::make('Edit')->route('admin.beneficio.edit')->xs()->icon('pencil-alt')->primary(),
