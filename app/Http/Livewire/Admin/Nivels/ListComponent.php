...
final class ListComponent extends TableComponent
{
    ...
    */
    ...
    public function route(){
        Route::get('/nivels', static::class)->name('admin.nivels');
    }

    public function getCreateProperty()
    {
        return 'admin.nivel.create';
    }
    ...
    */
    protected function actions(){
        ...
        return [
            Link::make('Edit')->route('admin.nivel.edit')->xs()->icon('pencil-alt')->primary(),
