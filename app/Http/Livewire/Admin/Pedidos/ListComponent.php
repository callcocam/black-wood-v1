...
final class ListComponent extends TableComponent
{
    ...
    */
    ...
    public function route(){
        Route::get('/pedidos', static::class)->name('admin.pedidos');
    }
    ...
    |  Features route
    |--------------------------------------------------------------------------
    | Rota create do crud, cria um novo cadastro
    |
    */
    ...
    */
    protected function actions(){
        ...
        return [
            Link::make('Edit')->route('admin.pedido.edit')->xs()->icon('pencil-alt')->primary(),
