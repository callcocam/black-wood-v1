...
final class ListComponent extends TableComponent
{
    ...
    public function mount()
    {
        ...
        \App\Helpers\LoadRouterHelper::save();
    }
     /*
    |--------------------------------------------------------------------------
    |  Features route
    ...
    */
    public function route(){
        Route::get('/permissions', static::class)->name('admin.permissions');
    }
    ...
    */
    protected function actions(){
        ...
        return [
            Link::make('Edit')->route('admin.permission.edit')->xs()->icon('pencil-alt')->primary(),
