...
final class ListComponent extends TableComponent
{
    ...
    */
    ...
    public function route(){
        Route::get('/categorias', static::class)->name('admin.categorias');
    }
    ...
    |  Features route
    |--------------------------------------------------------------------------
    | Rota create do crud, craia um novo cadastro
    |
    */
    public function getCreateProperty()
    {
        return 'admin.categoria.create';
    }
    ...
    */
    protected function actions(){
        ...
        return [
            Link::make('Edit')->route('admin.categoria.edit')->xs()->icon('pencil-alt')->primary(),
