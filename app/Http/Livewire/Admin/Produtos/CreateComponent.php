...
class CreateComponent extends FormComponent
{
    ...
    */
    public function route(){
        Route::get('/produto/create', static::class)->name('admin.produto.create');
    }
    ...
    */
    protected function fields(): array
    {
        return [
            ...
            Currency::make('Preço de custo','cost_price')->span('6')->rules('required'),
            Currency::make('Preço de venda','sale_price')->span(6)->rules('required'),
    ...
    */
    ...
    {
          return redirect()->route("admin.produto.edit", $this->model);
    }
