...
final class ListComponent extends TableComponent
{
    ...
    */
    ...
    public function route(){
        Route::get('/statuss', static::class)->name('admin.statuses');
    }
    ...
    */
    protected function actions(){
        ...
        return [
            Link::make('Edit')->route('admin.status.edit')->xs()->icon('pencil-alt')->primary(),
    ...
    */
    protected function columns(){
        return [
            ...
            Column::make('Slug')->searchable()->sortable(),
