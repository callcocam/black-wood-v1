        ...
        <div class="flex h-full flex-1">
            <ul class="flex items-center h-full w-full lg:w-7/12 justify-between">
                <li class="h-full w-full flex items-center"><a
                        ...
                        href="">Home</a></li>
                <li class="h-full w-full flex items-center"><a
                        class="h-full flex items-center border-t-4 font-bold transition-all ease-in-out duration-500 border-t-white hover:border-indigo-500 w-full justify-center"
                        href="">Listings</a></li>
                <li class="h-full w-full flex items-center"><a
                        class="h-full flex items-center border-t-4 font-bold transition-all ease-in-out duration-500 border-t-white hover:border-indigo-500 w-full justify-center"
                        href="">Property</a></li>
